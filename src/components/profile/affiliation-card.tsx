  ...
  return (
    ...
    >
      <div className="relative bg-white/[0.03] border border-white/[0.08] backdrop-blur-[10px] p-6 rounded-2xl h-full transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:border-primary hover:bg-primary/5 hover:shadow-[0_0_20px_rgba(139,92,246,0.15)]">
        <h3 className="text-[10px] text-secondary uppercase font-mono tracking-widest mb-4">Affiliation</h3>
        <p className="font-display text-lg md:text-xl text-white">Metropolitan Tech Institute</p>
        <p className="text-xs text-muted-foreground mt-2 font-body">Faculty of Computational Sciences</p>
      </div>
    </motion.div>
  )
}
